...
public class CameraView extends FrameLayout {
    ...
    interface CameraCallbacks extends OrientationHelper.Callback {
        ...
        void dispatchOnContinuousFocusMove(boolean start);
    ...
    private class Callbacks implements CameraCallbacks {
        ...
        @Override
        public void dispatchOnContinuousFocusMove(final boolean start){
            mLogger.i("dispatchOnContinuousFocusMove",start);
            mUiHandler.post(new Runnable() {
                @Override
                public void run() {
                    for (CameraListener listener : mListeners) {
                        listener.onContinuousFocusMove(start);
                    }
                }
            });
        }
